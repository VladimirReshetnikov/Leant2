...
\end{enumerate}
Related projects and fields: Hoogle+ and SyPet study type-directed component-based synthesis over large libraries; \code{exact?}, Loogle and Lean's premise-selection interface implement lookup and relevance ranking over Lean libraries; LeanDojo and the Lean hammer study learned premise selection.
