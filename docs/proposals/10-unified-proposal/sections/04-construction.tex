...
Case analysis is a motive-construction problem, delegated to Lean's own machinery behind a wrapper that returns the branch goals, the old-to-new local mapping, and any transport obligations\prov{\Pn{3},\Pn{4},\Pn{6},\Pn{8},\Pn{9}}.
