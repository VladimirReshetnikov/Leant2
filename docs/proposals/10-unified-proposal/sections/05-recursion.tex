...
Four prototypes independently produced an axiom-free recursor term that the code generator rejected (``code generator does not support recursor \code{T.rec} yet''). The consequence is a design rule\prov{\Pn{4},\Pn{6},\Pn{8},\Pn{9}}:
